...
export function PlanningMonitorModal({
  ...
  return createPortal(
    <div
      className="fixed inset-0 z-[82] bg-black/50 backdrop-blur-sm p-4"
      onMouseDown={(event) => {
    ...
    >
      <div className="flex h-full items-center justify-center pointer-events-none">
        <div className="pointer-events-auto flex h-full w-full max-w-[1440px] flex-col overflow-hidden rounded-[2rem] border border-white/20 bg-[#f8f8f6] shadow-2xl shadow-black/30 dark:bg-[#101115]">
